...
/**
 * Integration tests for Sqlx4kSqldelightDriver with MySQL using TestContainers.
 *
 * Tests the SQLDelight driver wrapper functionality with MySQL:
...
class Sqlx4kSqldelightDriverMySqlTest {
    ...
    private var sqlx4kDriver: IMySQL? = null
    private var sqldelightDriver: Sqlx4kSqldelightDriver<IMySQL>? = null
    ...
    fun setup() {
        ...
        runBlocking {
            ...
            sqlx4kDriver = mySQL(
                url = "mysql://${mysql.host}:${mysql.firstMappedPort}/${mysql.databaseName}",
